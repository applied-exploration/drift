def timing_of_flattening_and_flips(target_positions: pd.Series):
    """
...
def average_holding_period(target_positions: pd.Series):
    """
...
def bets_concentration(returns: pd.Series):
    """
...
def all_bets_concentration(returns: pd.Series, frequency: str = "M"):
    """
    Advances in Financial Machine Learning, Snippet 14.3, page 201
...
def drawdown_and_time_under_water(returns: pd.Series, dollars: bool = False):
    """
